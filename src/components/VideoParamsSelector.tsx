...
const VIDEO_MODEL_CAPS: Record<string, {
  ...
  'doubao-seedance-2-0-260128-1080p': {
    label: 'doubao-seedance-2-0-260128-1080p',
    resolution: ['1080p'],
    duration: { min: 4, max: 15 },
    ratio: ['21:9', '16:9', '4:3', '1:1', '3:4', '9:16'],
    audio: true,
  ...
  'doubao-seedance-2-0-260128-4k': {
    label: 'doubao-seedance-2-0-260128-4k',
    resolution: ['4k'],
    duration: { min: 4, max: 15 },
    ratio: ['21:9', '16:9', '4:3', '1:1', '3:4', '9:16'],
    audio: true,
  ...
  'doubao-seedance-2-0-fast-260128-480p': {
    label: 'doubao-seedance-2-0-fast-260128-480p',
    resolution: ['480p'],
    duration: { min: 4, max: 15 },
    ratio: ['21:9', '16:9', '4:3', '1:1', '3:4', '9:16'],
    audio: true,
  ...
  'doubao-seedance-2-0-mini-260615': {
    label: 'doubao-seedance-2-0-mini-260615',
    resolution: ['720p'],
    duration: { min: 4, max: 15 },
    ratio: ['21:9', '16:9', '4:3', '1:1', '3:4', '9:16'],
    audio: true,
