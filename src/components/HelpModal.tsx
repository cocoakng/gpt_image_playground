    ...
    >
      ...
      >
              ...
              <section>
                <div className="space-y-4">
                  <ul className="list-disc pl-4 space-y-2">
                    ...
                    <li>如需对话生图搜索互联网或读取 URL 内容，可在设置的 Agent 配置中开启"网络搜索"。</li>
                    <li>输入 <strong className="text-blue-500 dark:text-blue-400 font-medium">@</strong> 可引用参考图或前面轮次生成的图片；对话生图也会自行参考上下文中的图片。</li>
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-white/[0.08] flex justify-center">
          ...
          >
            <img src={logoUrl} alt="AI Link" className="w-5 h-5 group-hover:scale-110 transition-transform" />
            @AI Link
          </a>
        </div>
      </div>
